...
<template>
  <nav class="sticky top-0 z-20 flex items-center justify-between border-b border-white/7 bg-[rgba(10,7,8,0.9)] px-5 py-3.5 backdrop-blur-md md:px-16 md:py-5">
    <a
      href="#"
